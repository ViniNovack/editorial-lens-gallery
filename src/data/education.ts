...
const capturaPython = "https://raw.githubusercontent.com/ViniNovack/editorial-lens-gallery/main/src/assets/Captura%20de%20tela%202026-09-20%20101332.png";
...
export const schools: School[] = [
  ...
  },
  {
    ...
    socialLinks: {
      ...
      instagram: "https://www.instagram.com/data.icmc/",
    },
    tags: ["CURSOS"],
    year: "2026",
  ...
  },
  {
    ...
    images: [destPatrocinio, [imgWa0030, imgWa0014]],
    courses: [
      {
        id: "curso-python",
      ...
      },
      {
        ...
        year: "2026",
        website: "https://www.cursoemvideo.com/curso/curso-gratis-de-inteligencia-artificial/",
      ...
      },
      {
        ...
        year: "2026",
        studyRepositories: [
          { title: "Curso-em-V-deo-Python-com-Orienta-o-a-Objeto", url: "https://github.com/ViniNovack/Curso-em-V-deo-Python-com-Orienta-o-a-Objeto" },
        ],
        website: "https://www.cursoemvideo.com/curso/python-3-mundo-4-40-horas/",
